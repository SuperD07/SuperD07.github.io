...
[...document.querySelectorAll('td')].forEach(td => td.addEventListener('click', deletePiece));

document.addEventListener('mousedown', placePiece);
document.addEventListener('touchend', placePiece);